...
static int
acc200_bbdev_init(struct rte_bbdev *dev)
{
	...
	d->pf_device = pci_dev->id.device_id == RTE_ACC200_PF_DEVICE_ID;
...
static int
acc200_pci_probe(struct rte_pci_driver *pci_drv __rte_unused,
