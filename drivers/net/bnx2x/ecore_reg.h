...
#define AEU_INPUTS_ATTN_BITS_ATC_HW_INTERRUPT			 (UINT32_C(1) << 4)
#define AEU_INPUTS_ATTN_BITS_ATC_PARITY_ERROR			 (UINT32_C(1) << 5)
#define AEU_INPUTS_ATTN_BITS_BRB_HW_INTERRUPT			 (UINT32_C(1) << 19)
#define AEU_INPUTS_ATTN_BITS_BRB_PARITY_ERROR			 (UINT32_C(1) << 18)
#define AEU_INPUTS_ATTN_BITS_CCM_HW_INTERRUPT			 (UINT32_C(1) << 31)
#define AEU_INPUTS_ATTN_BITS_CCM_PARITY_ERROR			 (UINT32_C(1) << 30)
#define AEU_INPUTS_ATTN_BITS_CDU_HW_INTERRUPT			 (UINT32_C(1) << 9)
#define AEU_INPUTS_ATTN_BITS_CDU_PARITY_ERROR			 (UINT32_C(1) << 8)
#define AEU_INPUTS_ATTN_BITS_CFC_HW_INTERRUPT			 (UINT32_C(1) << 7)
#define AEU_INPUTS_ATTN_BITS_CFC_PARITY_ERROR			 (UINT32_C(1) << 6)
#define AEU_INPUTS_ATTN_BITS_CSDM_HW_INTERRUPT			 (UINT32_C(1) << 29)
#define AEU_INPUTS_ATTN_BITS_CSDM_PARITY_ERROR			 (UINT32_C(1) << 28)
#define AEU_INPUTS_ATTN_BITS_CSEMI_HW_INTERRUPT			 (UINT32_C(1) << 1)
#define AEU_INPUTS_ATTN_BITS_CSEMI_PARITY_ERROR			 (UINT32_C(1) << 0)
#define AEU_INPUTS_ATTN_BITS_DEBUG_PARITY_ERROR			 (UINT32_C(1) << 18)
#define AEU_INPUTS_ATTN_BITS_DMAE_HW_INTERRUPT			 (UINT32_C(1) << 11)
#define AEU_INPUTS_ATTN_BITS_DMAE_PARITY_ERROR			 (UINT32_C(1) << 10)
#define AEU_INPUTS_ATTN_BITS_DOORBELLQ_HW_INTERRUPT		 (UINT32_C(1) << 13)
#define AEU_INPUTS_ATTN_BITS_DOORBELLQ_PARITY_ERROR		 (UINT32_C(1) << 12)
#define AEU_INPUTS_ATTN_BITS_GPIO0_FUNCTION_0			 (UINT32_C(1) << 2)
#define AEU_INPUTS_ATTN_BITS_IGU_PARITY_ERROR			 (UINT32_C(1) << 12)
#define AEU_INPUTS_ATTN_BITS_MCP_LATCHED_ROM_PARITY		 (UINT32_C(1) << 28)
#define AEU_INPUTS_ATTN_BITS_MCP_LATCHED_SCPAD_PARITY		 (UINT32_C(1) << 31)
#define AEU_INPUTS_ATTN_BITS_MCP_LATCHED_UMP_RX_PARITY		 (UINT32_C(1) << 29)
#define AEU_INPUTS_ATTN_BITS_MCP_LATCHED_UMP_TX_PARITY		 (UINT32_C(1) << 30)
#define AEU_INPUTS_ATTN_BITS_MISC_HW_INTERRUPT			 (UINT32_C(1) << 15)
#define AEU_INPUTS_ATTN_BITS_MISC_PARITY_ERROR			 (UINT32_C(1) << 14)
#define AEU_INPUTS_ATTN_BITS_NIG_PARITY_ERROR			 (UINT32_C(1) << 14)
#define AEU_INPUTS_ATTN_BITS_PARSER_PARITY_ERROR		 (UINT32_C(1) << 20)
#define AEU_INPUTS_ATTN_BITS_PBCLIENT_HW_INTERRUPT		 (UINT32_C(1) << 31)
#define AEU_INPUTS_ATTN_BITS_PBCLIENT_PARITY_ERROR		 (UINT32_C(1) << 30)
#define AEU_INPUTS_ATTN_BITS_PBF_PARITY_ERROR			 (UINT32_C(1) << 0)
#define AEU_INPUTS_ATTN_BITS_PGLUE_HW_INTERRUPT			 (UINT32_C(1) << 2)
#define AEU_INPUTS_ATTN_BITS_PGLUE_PARITY_ERROR			 (UINT32_C(1) << 3)
#define AEU_INPUTS_ATTN_BITS_PXPPCICLOCKCLIENT_HW_INTERRUPT	 (UINT32_C(1) << 5)
#define AEU_INPUTS_ATTN_BITS_PXPPCICLOCKCLIENT_PARITY_ERROR	 (UINT32_C(1) << 4)
#define AEU_INPUTS_ATTN_BITS_PXP_HW_INTERRUPT			 (UINT32_C(1) << 3)
#define AEU_INPUTS_ATTN_BITS_PXP_PARITY_ERROR			 (UINT32_C(1) << 2)
#define AEU_INPUTS_ATTN_BITS_QM_HW_INTERRUPT			 (UINT32_C(1) << 3)
#define AEU_INPUTS_ATTN_BITS_QM_PARITY_ERROR			 (UINT32_C(1) << 2)
#define AEU_INPUTS_ATTN_BITS_SEARCHER_PARITY_ERROR		 (UINT32_C(1) << 22)
#define AEU_INPUTS_ATTN_BITS_SPIO5				 (UINT32_C(1) << 15)
#define AEU_INPUTS_ATTN_BITS_TCM_HW_INTERRUPT			 (UINT32_C(1) << 27)
#define AEU_INPUTS_ATTN_BITS_TCM_PARITY_ERROR			 (UINT32_C(1) << 26)
#define AEU_INPUTS_ATTN_BITS_TIMERS_HW_INTERRUPT		 (UINT32_C(1) << 5)
#define AEU_INPUTS_ATTN_BITS_TIMERS_PARITY_ERROR		 (UINT32_C(1) << 4)
#define AEU_INPUTS_ATTN_BITS_TSDM_HW_INTERRUPT			 (UINT32_C(1) << 25)
#define AEU_INPUTS_ATTN_BITS_TSDM_PARITY_ERROR			 (UINT32_C(1) << 24)
#define AEU_INPUTS_ATTN_BITS_TSEMI_HW_INTERRUPT			 (UINT32_C(1) << 29)
#define AEU_INPUTS_ATTN_BITS_TSEMI_PARITY_ERROR			 (UINT32_C(1) << 28)
#define AEU_INPUTS_ATTN_BITS_UCM_HW_INTERRUPT			 (UINT32_C(1) << 23)
#define AEU_INPUTS_ATTN_BITS_UCM_PARITY_ERROR			 (UINT32_C(1) << 22)
#define AEU_INPUTS_ATTN_BITS_UPB_HW_INTERRUPT			 (UINT32_C(1) << 27)
#define AEU_INPUTS_ATTN_BITS_UPB_PARITY_ERROR			 (UINT32_C(1) << 26)
#define AEU_INPUTS_ATTN_BITS_USDM_HW_INTERRUPT			 (UINT32_C(1) << 21)
#define AEU_INPUTS_ATTN_BITS_USDM_PARITY_ERROR			 (UINT32_C(1) << 20)
#define AEU_INPUTS_ATTN_BITS_USEMI_HW_INTERRUPT			 (UINT32_C(1) << 25)
#define AEU_INPUTS_ATTN_BITS_USEMI_PARITY_ERROR			 (UINT32_C(1) << 24)
#define AEU_INPUTS_ATTN_BITS_VAUX_PCI_CORE_PARITY_ERROR		 (UINT32_C(1) << 16)
#define AEU_INPUTS_ATTN_BITS_XCM_HW_INTERRUPT			 (UINT32_C(1) << 9)
#define AEU_INPUTS_ATTN_BITS_XCM_PARITY_ERROR			 (UINT32_C(1) << 8)
#define AEU_INPUTS_ATTN_BITS_XSDM_HW_INTERRUPT			 (UINT32_C(1) << 7)
#define AEU_INPUTS_ATTN_BITS_XSDM_PARITY_ERROR			 (UINT32_C(1) << 6)
#define AEU_INPUTS_ATTN_BITS_XSEMI_HW_INTERRUPT			 (UINT32_C(1) << 11)
#define AEU_INPUTS_ATTN_BITS_XSEMI_PARITY_ERROR			 (UINT32_C(1) << 10)
