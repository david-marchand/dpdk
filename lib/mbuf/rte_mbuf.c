...
int
rte_mbuf_check(const struct rte_mbuf *m, int is_header,
		   const char **reason)
{
...
void
rte_pktmbuf_free_bulk(struct rte_mbuf **mbufs, unsigned int count)
{
...
const void *
__rte_pktmbuf_read(const struct rte_mbuf *m, uint32_t off,
