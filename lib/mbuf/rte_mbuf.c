...
const char *rte_get_rx_ol_flag_name(uint64_t mask)
{
	...
	case RTE_MBUF_F_RX_FLAG: return "RTE_MBUF_F_RX_FLAG";
	...
	case RTE_MBUF_F_RX_MARK: return "RTE_MBUF_F_RX_MARK";
...
rte_get_rx_ol_flag_list(uint64_t mask, char *buf, size_t buflen)
{
	const struct flag_mask rx_flags[] = {
		...
		{ RTE_MBUF_F_RX_FLAG, RTE_MBUF_F_RX_FLAG, NULL },
		...
		{ RTE_MBUF_F_RX_MARK, RTE_MBUF_F_RX_MARK, NULL },
